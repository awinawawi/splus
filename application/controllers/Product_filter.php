...
class Product_filter extends CI_Controller
{
    ...
    function index()
    {
        $data['jenis_data'] = $this->product_filter_model->fetch_filter_type('product_brand');
        $data['tipe_data'] = $this->product_filter_model->fetch_filter_type('product_ram');
        $data['brand_data'] = $this->product_filter_model->fetch_filter_type('product_storage');
