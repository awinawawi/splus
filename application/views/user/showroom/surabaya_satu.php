  ...
  <div class="ps-container">
    <div class="row">
      <div class="col-md-6 col-sm-12 col-xs-12 gallery-popup pb-40">
        <img src="<?= base_url('assets/user/images/profile/surabaya2.jpg') ?>" alt="" <?php if ($this->agent->is_mobile()) {
        ...
        <div class="h-body h-m-body">
          ...
          <div class="row">
            <div class="col-md-4 col-sm-12 col-xs-12">
              <b>Telp.</b> <br>(031) 99853335<br>+62812-3120-0088<br>
            </div>
            <div class="col-md-8">
    ...
    <div class="row pt-40">
      ...
      <div class="col-md-2 col-sm-6 col-xs-6 pb-20 text-center">
        <img src="<?= base_url('assets/user/images/showroom/surabaya-1/tim/yuda.jpg') ?>" class="imground">
        <div class="h-body h-m-body"><b>Yuda</b></div>
        <div class="h-body h-m-body">0822 4443 1682</div>
      </div>
      <div class="col-md-2 col-sm-6 col-xs-6 pb-20 text-center">
        <img src="<?= base_url('assets/user/images/showroom/surabaya-1/tim/imam.jpg') ?>" class="imground">
        <div class="h-body h-m-body"><b>imam</b></div>
        <div class="h-body h-m-body">0822 9918 8099</div>
      </div>
    </div>
    ...
    <div class="row pt-40 pb-80 gallery-popup">
      ...
      <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 pb-20">
        <img src="<?= base_url('assets/user/images/showroom/surabaya-1/1.jpg') ?>" style="border-radius: 10px;"></a>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 pb-20">
        <img src="<?= base_url('assets/user/images/showroom/surabaya-1/2.jpg') ?>" style="border-radius: 10px;"></a>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 pb-20">
        <img src="<?= base_url('assets/user/images/showroom/surabaya-1/3.jpg') ?>" style="border-radius: 10px;"></a>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 pb-20">
        <img src="<?= base_url('assets/user/images/showroom/surabaya-1/4.jpg') ?>" style="border-radius: 10px;"></a>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 pb-20">
        <img src="<?= base_url('assets/user/images/showroom/surabaya-1/5.jpg') ?>" style="border-radius: 10px;"></a>
      </div>
    </div>
  </div>
