  ...
  <div class="ps-container">
    <div class="row">
      <div class="col-md-6 col-sm-12 col-xs-12 gallery-popup pb-40">
        <img src="<?= base_url('assets/user/images/profile/bandung.jpg') ?>" alt="" <?php if ($this->agent->is_mobile()) {
    ...
    <div class="row pt-40">
      ...
      <div class="col-md-2 col-sm-6 col-xs-6 pb-20 text-center" data-aos-delay="400">
        <img src="<?= base_url('assets/user/images/showroom/bandung-1/tim/rivan.jpg') ?>" class="imground">
        <div class="h-body h-m-body"><b>Rivan Indra Gumilar</b></div>
        <div class="h-body h-m-body">0822 1743 8434</div>
      </div>
    </div>
