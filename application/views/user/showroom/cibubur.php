...
<div class="ps-contact ps-section pb-40 pt-40">
  <div class="ps-container">
    ...
    <div class="row pt-40">
      ...
      <div class="col-md-2 col-sm-6 col-xs-6 pb-20 text-center">
        <img src="<?= base_url('assets/user/images/showroom/cibubur/romy.jpg') ?>" class="imground">
        <div class="h-body h-m-body"><b>Romy Taroreh</b></div>
        <div class="h-body h-m-body">0812 8338 3328</div>
      </div>
    </div>
