            ...
            <div class="row pb-50 pt-50">
                ...
                <div class="col-lg-12">
                    <div class="ps-box pb-40 pt-20 pl-20 pr-20 bg-white shd">
                        <div>
                            <h4><a href="<?= base_url('v_kategori') ?>"><b>Produk </b></a><span class="fa fa-chevron-right"></span><a href="<?= base_url('kategori/s-plus-wpc/wpc') ?>"><b> Exterior Product </b></a><span class="fa fa-chevron-right"></span><a href="<?= base_url('kategori/s-plus-wpc/wpc_kategori') ?>"><b> Wpc </b></a><span class="fa fa-chevron-right"><b> Wall Partition </b></h4>
                            <br>
                        </div>
                        <div class="">
                            <div class="">
