<?php
$meta['title']          = 'Aksesoris - S-Plus Indonesia';
            ...
            <div class="row pb-50 pt-50">
                ...
                <div class="col-md-9">
                    <div class="ps-box pb-40 pt-20 pl-20 pr-20 bg-white shd" style="background: url('<?= base_url('assets/user/images/background/bgproduk/produkbg2.jpg') ?>'); background-size: cover;" class="pt-10">
                        <div class="">
                            <center>
                                <span class="h-subtitle h-m-title"><strong>Our Aksesoris Product</strong></span>
                            </center>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 pb-20">
                                    <div class="container_images">
                                        <div class="content_img">
                                            <a href="<?= base_url('kategori/s-plus-aksesoris/aksesoris_pintu') ?>">
                                                <img src="<?= base_url('assets/user/images/kategori/produk/aksesoris/handle.jpg') ?>" alt="" class="image" width="80%">
                                                <div>More Detail</div>
                                            </a>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 pb-20">
                                    <div class="container_images">
                                        <div class="content_img">
                                            <a href="<?= base_url('kategori/s-plus-aksesoris/aksesoris_jendela') ?>">
                                                <img src="<?= base_url('assets/user/images/kategori/produk/aksesoris/ak-jendela.jpg') ?>" alt="" class="image" width="80%">
                                                <div>More Detail</div>
                                            </a>
                                        </div>
                                        <div class="text-center">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 pb-20">
                                    <div class="container_images">
                                        <div class="content_img">
                                            <a href="<?= base_url('kategori/s-plus-aksesoris/aksesoris_kitchenset') ?>">
                                                <img src="<?= base_url('assets/user/images/kategori/produk/aksesoris/kitchen.jpg') ?>" alt="" class="image" width="80%">
                                                <div>More Detail</div>
                                            </a>
                                        </div>
                                        <div class="text-center">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 pb-20">
                                    <div class="container_images">
                                        <div class="content_img">
                                            <a href="<?= base_url('kategori/s-plus-aksesoris/aksesoris_aoutomatic') ?>">
                                                <img src="<?= base_url('assets/user/images/kategori/produk/aksesoris/auto.jpg') ?>" alt="" class="image" width="80%">
                                                <div>More Detail</div>
                                            </a>
                                        </div>
                                        <div class="text-center">
                                            <div class="text-overlay-ss">AUTOMATIC</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 pb-20">
                                    <div class="container_images">
                                        <div class="content_img">
                                            <a href="<?= base_url('kategori/s-plus-aksesoris/aksesoris_cubicle') ?>">
                                                <img src="<?= base_url('assets/user/images/kategori/produk/aksesoris/cubicle.jpg') ?>" alt="" class="image" width="80%">
                                                <div>More Detail</div>
                                            </a>
                                        </div>
                                        <div class="text-center">
