<?php
$meta['title']          = 'Aksesoris Cubicle- S-Plus Indonesia';
            ...
            <div class="row pb-50 pt-50">
                ...
                <div class="col-lg-12">
                    <div class="ps-box pb-40 pt-20 pl-20 pr-20 bg-white shd">
                        <div>
                            <h4><a href="<?= base_url('v_kategori') ?>"><b>Produk </b></a><span class="fa fa-chevron-right"></span><a href="<?= base_url('kategori/s-plus-aksesoris') ?>"><b> Aksesoris </b></a><span class="fa fa-chevron-right"></span><b>Cubicle</b></h4>
                            <br>
                        </div>
                        ...
                        <center>
                            <span class="h-subtitle h-m-title" style="padding-bottom: 10px;" id="plafon"><strong>Macam-Macam Lainya Aksesoris</strong></span>
                        </center>
                        <hr style="margin-bottom: 25px;width: 15%; border: 0.5px solid #e24545">
                        <div class="row pb-40">
                            <?php if ($this->agent->is_mobile()) : ?>
                                <div class="col-sm-12 col-xs-12 gallery-popup">
                                    <img src="<?= base_url('assets/images/ourproduk/produk/aksesoris/acc-lainnya-m.jpg') ?>">
                                </div>
                            <?php else : ?>
                                <div class="col-md-12 pb-20 gallery-popup">
                                    <img class="" src="<?= base_url('assets/images/ourproduk/produk/aksesoris/acc-lainnya.jpg') ?>">
                                </div>
                            <?php endif; ?>
                        </div>
