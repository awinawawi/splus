            ...
            <div class="row pb-50 pt-50">
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 bg-white shd">
                   ...
                   <li class="panel-title current" data-toggle="collapse" data-target="#test7"><a href="<?=base_url('kategori/namo-pintu')?>"><b>NAMO PINTU</b></a></li>
                       <ul id="test7">
                           ...
                           <li class="sm current"><a href="<?=base_url('kategori/namo-pintu/duo')?>">Namo Duo</a></li>
                ...
                <div class="col-md-9">
                    <div class="ps-box pb-40 pt-20 pl-20 pr-20 bg-white shd">
                        <div class="">
                            <img src="<?=base_url('assets/user/images/kategori/splus-namo/duo/duo.jpg')?>"
                                class="pb-20">
                        </div>
                        <br>
                        <div class="">
                            <center>
                                <span class="h-subtitle h-m-title" style="padding-bottom: 10px; text-align: center;"><strong>TIPE-TIPE NAMO DUO</strong></span>
                            <hr style="margin-bottom: 25px;width: 25%; border: 0.5px solid #e24545">
                            </center>
                            <div class="row">
                            <?php if($this->agent->is_mobile()): ?>
                                <div class="col-sm-12 col-xs-12">
                                    <img src="<?=base_url('assets/user/images/kategori/splus-namo/duo/m-duo.png')?>">
                                </div>
                            <?php else: ?>
                                    ...
                                    <div class="ps-product--detail pt-10">
                                        <div class="ps-container">
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <div><img class=""
                                                        src="<?=base_url('assets/user/images/kategori/splus-namo/duo/detail.png')?>">         
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <?php endif; ?>
                                <div class="col-md-12 col-sm-12 col-xs-12 pb-40">
                                    ...
                                    <img src="<?=base_url('assets/user/images/kategori/splus-namo/duo/warna.png')?>">
                                </div>
                            </div> <br>
                        <!--portofolio-->
                           <div class="">
