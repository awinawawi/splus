<?php
$meta['title']          = 'Woven Vinyl Flooring - S-Plus Indonesia';
$meta['description']    = 'Woven Vinyl adalah material penutup lantai lunak yang memiliki karakterisitik lentur namun kuat. 
                                berbeda dengan vinyl lain, woven vinyl menggunakan bahan pelapis dengan texture seperti karpet yang didesain sedemikian rupa, 
                                mempunyai bermacam-macam corak, warna dan model tergantung selera kita.';
$meta['keywords']       = 'woven vinyl, splus woven vinyl, beli woven vinyl, moven vinyl indonesia';
            ...
            <div class="row pb-50 pt-50">
                        ...
                        <div class="ps-widget__content">
                            ...
                            <li class="panel-title current" data-toggle="collapse" data-target="#test9"><a href="<?= base_url('kategori/s-plus-vinyl-flooring') ?>"><b>S-PLUS VINYL FLOORING</b></a></li>
                                <ul id="test9" class="panel-collapse collapse">
                                    ...
                                    <li class="sm current"><a href="<?= base_url('kategori/s-plus-vinyl-flooring/woven-vinyl-flooring') ?>">Woven Vinyl Flooring</a></li>
                                </ul>
                ...
                <div class="col-lg-12">
                    <div class="ps-box pb-60 pt-20 pl-20 pr-20 bg-white shd">
                        ...
                        <div class="">
                            <center>
                                <span class="h-subtitle h-m-title"><strong>Woven Vinyl Flooring</strong></span>
                            </center>
                            <hr style="margin-bottom: 25px;width: 25%; border: 0.5px solid #e24545">
                            <p class="h-body h-m-body" style="text-align:justify;">
                                Woven Vinyl adalah material penutup lantai lunak yang memiliki karakterisitik lentur namun kuat.
                                berbeda dengan vinyl lain, woven vinyl menggunakan bahan pelapis dengan texture seperti karpet yang didesain sedemikian rupa,
                                mempunyai bermacam-macam corak, warna dan model tergantung selera kita.
                            </p>
                            <div class="row pb-20">
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <img src="<?= base_url('assets/user/images/kategori/splus-vinyl-flooring/woven-vinyl-flooring/detail-m.jpg') ?>" style="padding-top:20px;">
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12 pt-20" style="padding-top:15px; ">
                                    <span class="h-subtitle h-m-title" style="font-size:23px">Keunggulan Woven Vinyl Flooring :</span><br>
                            ...
                            <div class="pt-20 text-center pb-20">
                                <span class="h-subtitle h-m-title"><strong>Motif Woven Vinyl Flooring</strong></span>
                                <hr style="margin-bottom: 5px;width: 40%; border: 0.5px solid #e24545">
                                <div class="row pt-20">
                                    <img src="<?= base_url('assets/user/images/kategori/splus-vinyl-flooring/woven-vinyl-flooring/motif.png') ?>" style="padding-top:10px; width:70%;">
                                </div>
                            </div>
                        </div>
                        <div class="">
                            ...
                            <div class="row pb-20">
                                ...
                                <?php if ($this->agent->is_mobile()) : ?>
                                    <div class="col-sm-12 col-xs-12">
                                        <!-- <img src="<?= base_url('assets/user/images/kategori/splus-vinyl-flooring/woven-vinyl-flooring/lr-m.jpg') ?>" style="padding-top:10px;"> -->
                                        <img src="<?= base_url('assets/user/images/kategori/produk/vinyl/carpet-m.jpg') ?>" style="padding-top:10px;">
                                    </div>
                                <?php else : ?>
                                    <div class="col-md-12">
                                        <!-- <img src="<?= base_url('assets/user/images/kategori/splus-vinyl-flooring/woven-vinyl-flooring/lr.jpg') ?>" style="padding-top:10px;"> -->
                                        <img src="<?= base_url('assets/user/images/kategori/produk/vinyl/carpet.jpg') ?>" style="padding-top:10px;">
                                    </div>
                                <?php endif; ?>
                            </div>
                            <!-- <div class="row pb-20">
                                <h3 style="padding-left: 15px;"><b>Office</b></h3>
                                <hr style="width: 28%; border: 0.5px solid #e24545; margin-left:15px;">
                                <?php if ($this->agent->is_mobile()) : ?>
                                    <div class="col-sm-12 col-xs-12">
                                        <img src="<?= base_url('assets/user/images/kategori/splus-vinyl-flooring/woven-vinyl-flooring/ofc-m.jpg') ?>" style="padding-top:10px;">
                                    </div>
                                <?php else : ?>
                                    <div class="col-md-12">
                                        <img src="<?= base_url('assets/user/images/kategori/splus-vinyl-flooring/woven-vinyl-flooring/ofc.jpg') ?>" style="padding-top:10px;">
                                    </div>
                                <?php endif; ?>
                            </div>
                            <div class="row">
                                ...
                                <?php if ($this->agent->is_mobile()) : ?>
                                    <div class="col-sm-12 col-xs-12">
                                        <img src="<?= base_url('assets/user/images/kategori/splus-vinyl-flooring/woven-vinyl-flooring/bed-m.jpg') ?>" style="padding-top:10px;">
                                    </div>
                                <?php else : ?>
                                    <div class="col-md-12">
                                        <img src="<?= base_url('assets/user/images/kategori/splus-vinyl-flooring/woven-vinyl-flooring/bed.jpg') ?>" style="padding-top:10px;">
                                    </div>
                                <?php endif; ?>
                            </div> -->
                            <br>
