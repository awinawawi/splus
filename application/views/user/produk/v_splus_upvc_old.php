                        ...
                        <ul class="ps-list--arrow">
                           ...
                           <ul id="test8">
                            ...
                            <li class="panel-title" data-toggle="collapse" data-target="#test4"><a href="<?=base_url('kategori/s-plus-wpc')?>"><b>S-PLUS WPC</b></a></li>
                                ...
                                <li class="panel-title" data-toggle="collapse" data-target="#test5"><a
                                ...
                                <div id="jssor_1"
                                    ...
                                    <div data-u="slides"
                                        ...
                                        <div style="background-color:#000000;">
                                            <img data-u="image"
                                                src="<?=base_url('assets/user/images/kategori/splus-door/sash-door/sash-door.jpg')?>" />
                                        </div>

                                        <div style="background-color:#000000;">
                                            <img data-u="image"
                                                src="<?=base_url('assets/user/images/kategori/splus-door/felice/felice_old.jpg')?>" />
                                        </div>
                                    </div>
                                    <!-- Bullet Navigator -->
                                    ...
                                    <div class="ps-product--detail pt-30">
                                        <div class="ps-container">
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <div><img class=""
                                                        src="<?=base_url('assets/user/images/kategori/splus-door/felice/detail.jpg')?>" 
                                                        style="max-width: 90%;">         
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="ps-product--detail pt-30">
                                        <div class="ps-container">
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <div><img class=""
                                                        src="<?=base_url('assets/user/images/kategori/splus-door/sash-door/sash-door-detail.jpg')?>">         
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
