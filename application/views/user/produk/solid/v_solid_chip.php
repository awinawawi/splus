            ...
            <?php endif; ?>
                <div class="col-md-9">
                    <div class="ps-box pb-40 pt-20 pl-20 pr-20 bg-white shd">
                        <div class="">
                            <img src="<?=base_url('assets/user/images/kategori/splus-solid/solid.jpg')?>" class="pb-20"> <br>
                        </div>

                       <div class="">
                           <center>
                               <span class="h-subtitle h-m-title"style="padding-bottom: 10px;"><strong>TIPE SOLID CHIP</strong></span>
                           </center>
                           <hr style="width:20%; border: solid 0.5px #e24545; margin-bottom: 40px;">
                           <div class="row">
                           <?php if($this->agent->is_mobile()): ?>
                                <div class="col-sm-12 col-xs-12">
                                    <img src="<?=base_url('assets/user/images/kategori/splus-solid/chip/m-chip.png')?>">
                                </div>
                            <?php else: ?>
                               <div class="col-md-12">
                                   <!-- gambar produk -->
                                   <div class="ps-product--detail pt-10">
                                        <div class="ps-container">
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <div><img class=""
                                                        src="<?=base_url('assets/user/images/kategori/splus-solid/chip/detail.png')?>">         
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                           ...
                           <div class="pt-40">
                               ...
                               <div class="row pb-30 gallery-popup">
                                   <div class="col-lg-4 col-md-8 col-sm-12 col-xs-12">
                                       <img src="<?=base_url('assets/user/images/portfolio/chip/p1.jpg')?>"
                                           alt="">
                                   </div>
                                   <div class="col-lg-4 col-md-8 col-sm-12 col-xs-12 h-m-pdk">
                                       <img src="<?=base_url('assets/user/images/portfolio/chip/p2.jpg')?>"
                                           alt="">
                                   </div>
                                   <div class="col-lg-4 col-md-8 col-sm-12 col-xs-12 h-m-pdk">
                                       <img src="<?=base_url('assets/user/images/portfolio/chip/p3.jpg')?>"
                                           alt="">
                                   </div>
                               </div>
                           </div>
