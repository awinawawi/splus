<?php
$meta['title']          = 'Roll Screen- S-Plus Indonesia';
$meta['description']    = 'S-Plus roll screen berfungsi sebagai pelindung ruangan dari sinar matahari & pendukung keindahan interior anda, tidak hanya berfungsi sebagai pelindung ruangan dari efek negatif panas dan cahaya sinar matahari.';
$meta['keywords']       = 'jual roll screen, jual roll screen murah, jual roll screen berkualitas, jual roll screen terbaik, roll screen murah, roll screen minimalis, roll screen elegan, roll screen terbaik, roll screen berkualitas, roller blind, roller blind harga, roller blind s plus, sun shade s plus';
            ...
            <div class="row pb-50 pt-50">
                        ...
                        <div class="ps-widget__content">
                            <ul class="ps-list--arrow">
                                ...
                                <ul id="test5">
                                    ...
                                    <li class="sm current"><a href="<?= base_url('kategori/s-plus-sun-shade/roll-screen') ?>">Roll Screen</a></li>
                ...
                <div class="col-lg-12">
                    <div class="ps-box pb-60 pt-20 pl-20 pr-20 bg-white shd">
                        ...
                        <div class="">
                            <center>
                                <span class="h-subtitle h-m-title"><strong>ROLL SCREEN</strong></span>
                            </center>
                            <hr style="margin-bottom: 25px;width: 25%; border: 0.5px solid #e24545">
                            <div class="row">
                                <?php if ($this->agent->is_mobile()) : ?>
                                    <div class="col-sm-12 col-xs-12">
                                        <img src="<?= base_url('assets/user/images/kategori/produk/sun_shade/rollscreen-m.jpg') ?>">
                                    </div>
                                <?php else : ?>
                                    <div class="col-md-12">
                                        <img src="<?= base_url('assets/user/images/kategori/produk/sun_shade/rollscreen.jpg') ?>">
                        ...
                        <br>
                        <a href="<?= base_url('order/sunshade-roll-screen') ?>" class="btn btn-primary pull-right">PESAN SEKARANG</a>
                    </div>
                </div>
            </div>
        </div>
