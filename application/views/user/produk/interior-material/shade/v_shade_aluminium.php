<?php
$meta['title']          = 'Horizontal Aluminium - S-Plus Indonesia';
$meta['description']    = 'S-Plus Sun shade alumunium berfungsi sebagai pelindung ruangan dari sinar matahari & pendukung keindahan interior anda, tidak hanya berfungsi sebagai pelindung ruangan dari efek negatif panas dan cahaya sinar matahari.';
$meta['keywords']       = 'jual sun shade alumunium, jual sun shade alumunium murah, jual sun shade alumunium berkualitas, jual sun shade alumunium terbaik, sun shade alumunium murah, sun shade alumunium minimalis, sun shade alumunium elegan, sun shade alumunium terbaik, sun shade alumunium berkualitas, roller blind, roller blind harga, roller blind s plus, sun shade s plus, roller blind alumunium';
            ...
            <div class="row pb-50 pt-50">
                        ...
                        <div class="ps-widget__content">
                            <ul class="ps-list--arrow">
                                ...
                                <li class="panel-title" data-toggle="collapse" data-target="#test2">
                                    <a href="<?= base_url('kategori/s-plus-upvc-jendela') ?>"><b>S-PLUS JENDELA UPVC</b></a>
                                </li>
                                ...
                                <ul id="test5">
                                    ...
                                    <li class="sm current"><a href="<?= base_url('kategori/s-plus-sun-shade/alumunium') ?>">Horizontal Aluminium</a></li>
                ...
                <div class="col-lg-12">
                    <div class="ps-box pb-60 pt-20 pl-20 pr-20 bg-white shd">
                        <div>
                            <h4><a href="<?= base_url('v_kategori') ?>"><b>Produk </b></a><span class="fa fa-chevron-right"></span><a href="<?= base_url('kategori/s-plus-interior-material') ?>"><b> Interior Material </b></a><span class="fa fa-chevron-right"></span><a href="<?= base_url('kategori/s-plus-sun-shade/sun-shead') ?>"><b> Sun Shade </b></a><span class="fa fa-chevron-right"><b> Horizontal Aluminium</b></h4>
                            <br>
                        </div>
                        <div class="">
                            <img src="<?= base_url('assets/user/images/kategori/produk/sun_shade/sunshade.jpg') ?>"><br><br>
                            <span class="h-subtitle h-m-title"><b>Horizontal Aluminium</b></span> <br>
                            <ul class="a h-body h-m-body">
                                <li>Bahan Utama Horizontal Aluminium adalah Aluminium 100% </li>
                                <li>Ketebalan : 0.21 mm ± 5%</li>
                                <li>Direkomendasikan untuk di dalam dan luar ruangan ( tidak mudah melengkung/bengkok jika terkena sinar matahari)</li>
                            </ul>
                        </div>
                        <br>
                        <div class="">
                            <center>
                                <span class="h-subtitle h-m-title"><strong>HORIZONTAL ALUMINIUM</strong></span>
                            </center>
                            <hr style="margin-bottom: 25px;width: 25%; border: 0.5px solid #e24545">
                            <div class="row">
                                <?php if ($this->agent->is_mobile()) : ?>
                                    <div class="col-sm-12 col-xs-12">
                                        <img src="<?= base_url('assets/user/images/kategori/produk/sun_shade/aluminium-m.jpg') ?>">
                                    </div>
                                <?php else : ?>
                                    <div class="col-md-12">
                                        <img src="<?= base_url('assets/user/images/kategori/produk/sun_shade/aluminium.jpg') ?>">
                        ...
                        <br>
                        <a href="<?= base_url('order/sunshade-horizontal-alumunium') ?>" class="btn btn-primary pull-right">PESAN SEKARANG</a>
                    </div>
                </div>
            </div>
        </div>
