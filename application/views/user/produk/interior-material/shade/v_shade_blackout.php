<?php
$meta['title']          = 'Blackout Shade - S-Plus Indonesia';
$meta['description']    = 'S-Plus Sun shade blackout berfungsi sebagai pelindung ruangan dari sinar matahari & pendukung keindahan interior anda, tidak hanya berfungsi sebagai pelindung ruangan dari efek negatif panas dan cahaya sinar matahari.';
$meta['keywords']       = 'jual sun shade blackout, jual sun shade blackout murah, jual sun shade blackout berkualitas, jual sun shade blackout terbaik, sun shade blackout murah, sun shade blackout minimalis, sun shade blackout elegan, sun shade blackout terbaik, sun shade blackout berkualitas,roller blind, roller blind harga, roller blind s plus, sun shade s plus, roller blind blackout';
            ...
            <div class="row pb-50 pt-50">
                            ...
                            <ul class="ps-list--arrow">
                                ...
                                <ul id="test2" class="panel-collapse collapse">
                                    ...
                                    <li class="sm"><a href="<?= base_url('kategori/s-plus-upvc-jendela/swing') ?>">Jendela
                                            Swing</a></li>
                                    <li class="sm"><a href="<?= base_url('kategori/s-plus--upvcjendela/kombinasi') ?>">Jendela
                                            Kombinasi</a></li>
                                </ul>
                              <li class=" panel-title" data-toggle="collapse" data-target="#test3"><a href="<?= base_url('kategori/s-plus-interior-material') ?>"><b>S-PLUS PLAFON UPVC</b></a></li>  
                                ...
                                <ul id="test5">
                                    ...
                                    <li class="sm current"><a href="<?= base_url('kategori/s-plus-sun-shade/blackout') ?>">Blackout Roll Screen</a></li>
                ...
                <div class="col-lg-12">
                    <div class="ps-box pb-60 pt-20 pl-20 pr-20 bg-white shd">
                        <div>
                            <h4><a href="<?= base_url('v_kategori') ?>"><b>Produk </b></a><span class="fa fa-chevron-right"></span><a href="<?= base_url('kategori/s-plus-interior-material') ?>"><b> Interior Material </b></a><span class="fa fa-chevron-right"></span><a href="<?= base_url('kategori/s-plus-sun-shade/sun-shead') ?>"><b> Sun Shade </b></a><span class="fa fa-chevron-right"><b> Blackout Roll Screen </b></h4>
                            <br>
                        </div>
                        <div class="">
                            <img src="<?= base_url('assets/user/images/kategori/produk/sun_shade/sunshade.jpg') ?>"> <br> <br>
                            <span class="h-subtitle h-m-title"><b>Blackout Roll Screen</b></span> <br>
                            <ul class="a h-body h-m-body">
                                <li>Bahan utama Blackout Roll Screen adalah Polyester 100%</li>
                                <li>Direkomendasikan untuk didalam ruangan atau di ruangan rapat, Karena dapat digunakan
                                    untuk layar projector.</li>
                            </ul>
                        </div>
                        <br>
                        <div class="">
                            <center>
                                <span class="h-subtitle h-m-title"><strong>BLACKOUT ROLL SCREEN</strong></span>
                            </center>
                            <hr style="margin-bottom: 25px;width: 25%; border: 0.5px solid #e24545">
                            <div class="row">
                                <?php if ($this->agent->is_mobile()) : ?>
                                    <div class="col-sm-12 col-xs-12">
                                        <img src="<?= base_url('assets/user/images/kategori/produk/sun_shade/blackout-m.jpg') ?>">
                                    </div>
                                <?php else : ?>
                                    <div class="col-md-12">
                                        <img src="<?= base_url('assets/user/images/kategori/produk/sun_shade/blackout.jpg') ?>">
                        ...
                        <br>
                        <a href="<?= base_url('order/sunshade-black-out-roll-screen') ?>" class="btn btn-primary pull-right">PESAN SEKARANG</a>
                    </div>
                </div>
            </div>
        </div>
