<?php
$meta['title']          = 'Vertical Blind- S-Plus Indonesia';
$meta['description']    = 'S-Plus vertical blind berfungsi sebagai pelindung ruangan dari sinar matahari & pendukung keindahan interior anda, tidak hanya berfungsi sebagai pelindung ruangan dari efek negatif panas dan cahaya sinar matahari.';
$meta['keywords']       = 'jual vertical blind, jual vertical blind murah, jual vertical blind berkualitas, jual vertical blind terbaik, vertical blind murah, vertical blind minimalis, vertical blind elegan, vertical blind terbaik, vertical blind berkualitas,roller blind, roller blind harga, roller blind s plus, sun shade s plus';
            ...
            <div class="row pb-50 pt-50">
                        ...
                        <div class="ps-widget__content">
                            <ul class="ps-list--arrow">
                                ...
                                <li class="panel-title" data-toggle="collapse" data-target="#test8"><a
                                        href="<?= base_url('kategori/s-plus-upvc-pintu') ?>"><b>S-PLUS PINTU UPVC</b></a>
                                </li>
                                ...
                                <ul id="test2" class="panel-collapse collapse">
                                    ...
                                    <li class="sm"><a href="<?= base_url('kategori/s-plus-upvc-jendela/swing') ?>">Jendela
                                            Swing</a></li>
                                    <li class="sm"><a href="<?= base_url('kategori/s-plus-upvc-jendela/kombinasi') ?>">Jendela
                                            Kombinasi</a></li>
                                </ul>
                                ...
                                <ul id="test5">
                                    ...
                                    <li class="sm current"><a href="<?= base_url('kategori/s-plus-sun-shade/vertical') ?>">Vertical Blind</a></li>
                ...
                <div class="col-lg-12">
                    <div class="ps-box pb-60 pt-20 pl-20 pr-20 bg-white shd">
                        <div>
                            <h4><a href="<?= base_url('v_kategori') ?>"><b>Produk </b></a><span class="fa fa-chevron-right"></span><a href="<?= base_url('kategori/s-plus-interior-material') ?>"><b> Interior Material </b></a><span class="fa fa-chevron-right"></span><a href="<?= base_url('kategori/s-plus-sun-shade/sun-shead') ?>"><b> Sun Shade </b></a><span class="fa fa-chevron-right"><b> Vertical Blind </b></h4>
                            <br>
                        </div>
                        <div class="">
                            <img src="<?= base_url('assets/user/images/kategori/produk/sun_shade/sunshade.jpg') ?>"> <br> <br>
                            <span class="h-subtitle h-m-title"><b>Vertical Blind</b></span> <br>
                            <ul class="a h-body h-m-body">
                                <li>Tirai penutup jendela dari jenis blinds yang berbentuk vertikal</li>
                                <li>Bahan dasar kain tapi mempunyai kain yang bertekstur kaku</li>
                                <li>Vertical blind digunakan untuk penutup jendela dan pengatur cahaya yang masuk ke dalam ruangan</li>
                                <li>Vertical blind biasanya banyak digunakan pada kantor-kantor karena jenis tirai ini dapat memberikan kesan
                                    formal dan minimalis namun dapat juga sebagai gorden di rumah</li>
                            </ul>
                        </div>
                        <br>
                        <div class="">
                            <center>
                                <span class="h-subtitle h-m-title"><strong>VERTICAL BLIND</strong></span>
                            </center>
                            <hr style="margin-bottom: 25px;width: 20%; border: 0.5px solid #e24545">
                            <div class="row">
                                <?php if ($this->agent->is_mobile()) : ?>
                                    <div class="col-sm-12 col-xs-12">
                                        <img src="<?= base_url('assets/user/images/kategori/produk/sun_shade/vertical-m.jpg') ?>">
                                    </div>
                                <?php else : ?>
                                    <div class="col-md-12">
                                        <img src="<?= base_url('assets/user/images/kategori/produk/sun_shade/vertical.jpg') ?>">
                        ...
                        <br>
                        <a href="<?= base_url('order/sunshade-vertical-blind') ?>" class="btn btn-primary pull-right">PESAN SEKARANG</a>
                    </div>
                </div>
            </div>
        </div>
