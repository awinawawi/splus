<?php
$meta['title']          = 'Horizontal Wood- S-Plus Indonesia';
$meta['description']    = 'S-Plus Horizontal Wood berfungsi sebagai pelindung ruangan dari sinar matahari & pendukung keindahan interior anda, tidak hanya berfungsi sebagai pelindung ruangan dari efek negatif panas dan cahaya sinar matahari.';
$meta['keywords']       = 'wood blind,jual wood blind, jual wood blind murah, jual wood blind berkualitas, jual wood blind terbaik, wood blind murah, wood blind minimalis, wood blind elegan, wood blind terbaik, wood blind berkualitas,roller blind, roller blind harga, roller blind s plus, sun shade s plus';
                        ...
                        <div class="ps-widget__content">
                            <ul class="ps-list--arrow">
                                ...
                                <ul id="test5">
                                    ...
                                    <li class="sm current"><a href="<?= base_url('kategori/s-plus-sun-shade/wood') ?>">Horizontal Wood</a></li>
                ...
                <div class="col-lg-12">
                    <div class="ps-box pb-60 pt-20 pl-20 pr-20 bg-white shd">
                        ...
                        <div class="">
                            ...
                            <span class="h-subtitle h-m-title"><b>Horizontal Wood</b></span> <br>
                            <ul class="a h-body h-m-body">
                                <li>Bahan Utama Horizontal Wood adalah Paulowniawood 100% </li>
                                <li>Ketebalan : 3 mm ± 5%</li>
                                <li>Direkomendasikan untuk didalam dan luar ruangan ( tidak mudah melengkung/bengkok
                        ...
                        <div class="">
                            <center>
                                <span class="h-subtitle h-m-title"><strong>HORIZONTAL WOOD</strong></span>
                            </center>
                            <hr style="margin-bottom: 25px;width: 25%; border: 0.5px solid #e24545">
                            <div class="row">
                                <?php if ($this->agent->is_mobile()) : ?>
                                    <div class="col-sm-12 col-xs-12">
                                        <img src="<?= base_url('assets/user/images/kategori/produk/sun_shade/wood-m.jpg') ?>">
                                    </div>
                                <?php else : ?>
                                    <div class="col-md-12">
                                        <img src="<?= base_url('assets/user/images/kategori/produk/sun_shade/wood.jpg') ?>">
                        ...
                        <br>
                        <a href="<?= base_url('order/sunshade-horizontal-wood') ?>" class="btn btn-primary pull-right">PESAN SEKARANG</a>
                    </div>
                </div>
            </div>
        </div>
