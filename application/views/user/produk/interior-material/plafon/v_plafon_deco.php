            ...
            <div class="row pb-50 pt-50">
                ...
                <div class="col-lg-12">
                    <div class="ps-box pb-40 pt-20 pl-20 pr-20 bg-white shd">
                        <div>
                            <h4><a href="<?= base_url('kategori') ?>"><b>Produk </b></a><span class="fa fa-chevron-right"></span><a href="<?= base_url('kategori/s-plus-interior-material') ?>"><b> Interior Material </b></a><span class="fa fa-chevron-right"></span><a href="<?= base_url('kategori/s-plus-interior-material/plafon_upvc') ?>"><b> Plafon </b></a><span class="fa fa-chevron-right"><b> Plafon Deco </b></h4>
                            <br>
                        </div>
                        <div class="">
                            <div class="">
                        ...
                        <center>
                            <span class="h-subtitle h-m-title" style="padding-bottom: 10px;" id="plafon"><strong>PLAFON DECO</strong></span>
                        </center>
                        ...
                        <div class="row pt-40">
                            <div class="col-md-12 col-sm-6 col-xs-12">
                                <center><a href="<?= base_url('kategori/s-plus-interior-material/plafon_upvc') ?>" class="ps-btn h-m-body">Kembali</a></center>
                            </div>
