            ...
            <div class="row pb-50 pt-50">
                            ...
                            <div class="ps-widget__content ">
                                <ul class="ps-list--arrow">
                                    ...
                                    <li class="panel-title " data-toggle="collapse" data-target="#test4">
                                        ...
                                        <ul id="test4">
                                            <li class="sm panel-title" data-toggle="collapse" data-target="#testsp9"><a href="<?= base_url('kategori/s-plus-wpc/wpc_kategori') ?>" style="color:#e24545;"><b>WPC</b></a>
                ...
                <div class="col-md-9">
                    <div class="ps-box pb-40 pt-20 pl-20 pr-20 bg-white shd">
                        <div class="">
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                                    <div class="text-center">
                                        <div class="img-fluid mb-4">
                                            <a href="<?= base_url('kategori/s-plus-wpc/deck-tile') ?>">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                                    <div class="text-center">
                                        <div class="img-fluid mb-4">
                                            <a href="<?= base_url('kategori/s-plus-wpc/wall-partition') ?>">
                        ...
                        <div class="">
                            <center>
                                <span class="h-subtitle h-m-title"><strong>S-PLUS WPC</strong></span>
                            </center>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 pb-20">
                                    <div class="container_images">
                                        ...
                                        <div class="text-center">
                                            <div class="text-overlay-ss">Deck Tile</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 pb-20">
                                    <div class="container_images">
                                        ...
                                        <div class="text-center">
                                            <div class="text-overlay-ss">Wall Partition</div>
                                        </div>
                                    </div>
                                </div>
