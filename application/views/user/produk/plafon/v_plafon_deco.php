            ...
            <div class="row pb-50 pt-50">
                ...
                <div class="col-md-9">
                    <div class="ps-box pb-40 pt-20 pl-20 pr-20 bg-white shd">
                        <div class="">
                            <img src="<?= base_url('assets/user/images/kategori/splus-plafon/plafon-deco.jpg') ?>" class="pb-20">
                        </div>
                        <div class="">
                            <center>
                                <span class="h-subtitle h-m-title" style="padding-bottom: 10px;"><strong>TIPE PLAFON DECO</strong></span>
                            </center>
                            ...
                            <div class="row">
                                <?php if ($this->agent->is_mobile()) : ?>
                                    <div class="col-sm-12 col-xs-12">
                                        <img src="<?= base_url('assets/user/images/kategori/splus-plafon/deco/m-deco.png') ?>">
                                    </div>
                                <?php else : ?>
                                    <div class="col-md-12">
                                        <!-- gambar produk -->
                                        <div class="ps-product--detail pt-10">
                                            <div class="ps-container">
                                                <div class="row">
                                                    <div class="col-md-9">
                                                        <div><img class="" src="<?= base_url('assets/user/images/kategori/splus-plafon/deco/detail.png') ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="">
                                <div class="row pt-30 pb-20">
                                    <center>
                                        <span class="h-subtitle h-m-title" style="padding-bottom: 10px;"><strong>DETAIL UKURAN PLAFON </strong></span>
                                    </center>
                                    <hr style="margin-bottom: 25px;width: 30%; border: 0.5px solid #e24545">
                                    <div class="col-md-3"></div>
                                    <div class="col-md-6">
                                        <center>
                                            <img src="<?= base_url("assets/user/images/kategori/splus-plafon/plafon-200.jpg") ?>">
                                        </center>
                                    </div>
                                </div>
                            </div>
                            <div class="">
                                ...
                                <div class="row gallery-popup">
                                    <div class="col-lg-4 col-md-8 col-sm-12 col-xs-12">
                                        <img src="<?= base_url("assets/user/images/portfolio/plafon/laminate/laminate.png") ?>">
                                    </div>
