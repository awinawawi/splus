                            ...
                            <div class="row pb-20">
                                ...
                                <?php if ($this->agent->is_mobile()) : ?>
                                    <div class="col-sm-12 col-xs-12">
                                        <img src="<?= base_url('assets/user/images/kategori/produk/ambalan/floatings-m.jpg') ?>" style="padding-top:10px;">
                                        <img src="<?= base_url('assets/user/images/kategori/produk/ambalan/walls-m.jpg') ?>" style="padding-top:10px;">
                                    </div>
                                <?php else : ?>
                                    <div class="col-md-12">
                                        <img src="<?= base_url('assets/user/images/kategori/produk/ambalan/floatings.jpg') ?>" style="padding-top:10px;">
                                        <img src="<?= base_url('assets/user/images/kategori/produk/ambalan/walls.jpg') ?>" style="padding-top:10px;">
                                    </div>
                                <?php endif; ?>
                            </div>
