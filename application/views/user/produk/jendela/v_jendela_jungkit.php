<?php
$meta['title']          = 'Jendela Jungkit - S-Plus Indonesia';
...
$meta['keywords']       = 'jual jendela jungkit upvc, jual jendela jungkit upvc murah, jual jendela jungkit upvc berkualitas, jual jendela jungkit upvc terbaik, jendela jungkit upvc murah, jendela jungkit upvc minimalis, jendela jungkit upvc elegan, jendela jungkit upvc terbaik, jendela jungkit upvc berkualitas,jendela upvc s plus';
            ...
            <div class="row pb-50 pt-50">
                ...
                <div class="col-lg-12">
                    <div class="ps-box pb-40 pt-20 pl-20 pr-20 bg-white shd">
                        ...
                        <div class="">
                            <center>
                                <span class="h-subtitle"><strong>JENDELA JUNGKIT</strong></span>
                            </center>
                            ...
                            <div class="row">
                                <?php if ($this->agent->is_mobile()) : ?>
                                    <div class="col-sm-12 col-xs-12">
                                        <img src="<?= base_url('assets/user/images/kategori/splus-sash/jungkit/detail-mobile.jpg') ?>">
                                    </div>
                                <?php else : ?>
                                    <div class="col-md-12">
                                        <img src="<?= base_url('assets/user/images/kategori/splus-sash/jungkit/detail.jpg') ?>">
                                    </div>
                                <?php endif; ?>
                            </div> <br>
                            <div class="">
                                ...
                                <div class="row gallery-popup">
                                    <div class="col-lg-4 col-md-8 col-sm-12 col-xs-12">
                                        <img src="<?= base_url('assets/user/images/portfolio/jendela/jungkit/jungkit-1.jpg') ?>" alt="">
                                    </div>
                                    <div class="col-lg-4 col-md-8 col-sm-12 col-xs-12 h-m-pdk">
                                        <img src="<?= base_url('assets/user/images/portfolio/jendela/jungkit/jungkit-2.jpg') ?>" alt="">
                                    </div>
                                    <div class="col-lg-4 col-md-8 col-sm-12 col-xs-12 h-m-pdk">
                                        <img src="<?= base_url('assets/user/images/portfolio/jendela/jungkit/jungkit-4.jpg') ?>" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
