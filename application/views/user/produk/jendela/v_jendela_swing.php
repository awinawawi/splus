<?php
$meta['title']          = 'Jendela Swing - S-Plus Indonesia';
$meta['description']    = 'S-Plus jendela swing merupakan penggabungan pintar antara desain dan teknologi dalam menjadikan tampilan ruangan semakin kaya dan mempesona. S-Plus jendela memiliki design yang minimalis serta cocok dan menyatu dengan ruangan apapun sehingga menjadikan ruang terkesan lebih luas dan rapih.';
$meta['keywords']       = 'jual jendela swing upvc, jual jendela swing upvc murah, jual jendela swing upvc berkualitas, jual jendela swing upvc terbaik, jendela swing upvc murah, jendela swing upvc minimalis, jendela swing upvc elegan, jendela swing upvc terbaik, jendela swing upvc berkualitas,jendela upvc s plus';
            ...
            <div class="row pb-50 pt-50">
                ...
                <div class="col-lg-12">
                    <div class="ps-box pb-40 pt-20 pl-20 pr-20 bg-white shd">
                        ...
                        <div class="">
                            <center>
                                <span class="h-subtitle h-m-title"><strong>JENDELA SWING</strong></span>
                            </center>
                            ...
                            <div class="row">
                                <?php if ($this->agent->is_mobile()) : ?>
                                    <div class="col-sm-12 col-xs-12">
                                        <img src="<?= base_url('assets/user/images/kategori/splus-sash/swing/m-swing.jpg') ?>">
                                    </div>
                                <?php else : ?>
                                    <div class="col-md-12">
                                        <img src="<?= base_url('assets/user/images/kategori/splus-sash/swing/detail.jpg') ?>">
                                    </div>
                                <?php endif; ?>
                            </div> <br>
                            <div class="">
                                ...
                                <div class="row gallery-popup">
                                    <div class="col-lg-4 col-md-8 col-sm-12 col-xs-12">
                                        <img src="<?= base_url('assets/user/images/portfolio/jendela/swing/1.jpg') ?>" alt="">
                                    </div>
                                    <div class="col-lg-4 col-md-8 col-sm-12 col-xs-12 h-m-pdk">
                                        <img src="<?= base_url('assets/user/images/portfolio/jendela/swing/2.jpg') ?>" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
