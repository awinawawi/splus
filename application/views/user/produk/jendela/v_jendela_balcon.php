<?php
$meta['title']          = 'Jendela Balcon - S-Plus Indonesia';
...
$meta['keywords']       = 'jual pintu abs, jual pintu abs murah, jual pintu abs berkualitas, jual pintu abs terbaik, pintu abs murah, pintu abs minimalis, pintu abs elegan, pintu abs terbaik, pintu abs berkualitas';
            ...
            <div class="row pb-50 pt-50">
                ...
                <div class="col-md-9">
                    <div class="ps-box pb-40 pt-20 pl-20 pr-20 bg-white shd">
                        ...
                        <div class="">
                            <center>
                                <span class="h-subtitle h-m-title"><strong>Detail Jendela Kaca Mati</strong></span>
                            </center>
                            <hr style="margin-bottom: 25px;width: 37%; border: 0.5px solid #e24545">
                            <center>
                                <img src="<?= base_url('assets/user/images/kategori/splus-sash/fixed/struktur.png') ?>" class="pb-40">
                            </center>
                        </div> <br>
                        <div class="">
                            <center>
                                <span class="h-subtitle h-m-title"><strong>Tipe-Tipe Jendela Kaca Mati</strong></span>
                            </center>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="ps-product--detail pt-10">
                                        <div class="ps-container">
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <div><img class="" src="<?= base_url('assets/user/images/kategori/splus-door/classic/door.png') ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-8 col-sm-12 col-xs-12">
                                    <img src="<?= base_url('assets/user/images/kategori/splus-sash/fixed/portofolio Fixed-Galass-Single.jpg') ?>" alt="">
                                </div>
                                <div class="col-lg-4 col-md-8 col-sm-12 col-xs-12 h-m-pdk">
                                    <img src="<?= base_url('assets/user/images/kategori/splus-sash/fixed/portofolio Fixed-Galass-Single2.jpg') ?>" alt="">
                                </div>
                                <div class="col-lg-4 col-md-8 col-sm-12 col-xs-12 h-m-pdk">
                                    <img src="<?= base_url('assets/user/images/kategori/splus-sash/fixed/portofolio Fixed-Galass-Single3.jpg') ?>" alt="">
                                </div>
                            </div>
