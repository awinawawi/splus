<?php
$meta['title']          = 'Jendela Kombinasi - S-Plus Indonesia';
$meta['description']    = 'S-Plus jendela kombinasi merupakan penggabungan pintar antara desain dan teknologi dalam menjadikan tampilan ruangan semakin kaya dan mempesona. S-Plus jendela memiliki design yang minimalis serta cocok dan menyatu dengan ruangan apapun sehingga menjadikan ruang terkesan lebih luas dan rapih.';
$meta['keywords']       = 'jual jendela kombinasi upvc, jual jendela kombinasi upvc murah, jual jendela kombinasi upvc berkualitas, jual jendela kombinasi upvc terbaik, jendela kombinasi upvc murah, jendela kombinasi upvc minimalis, jendela kombinasi upvc elegan, jendela kombinasi upvc terbaik, jendela kombinasi upvc berkualitas,jendela upvc s plus';
            ...
            <div class="row pb-50 pt-50">
                ...
                <div class="col-lg-12">
                    <div class="ps-box pb-40 pt-20 pl-20 pr-20 bg-white shd">
                        ...
                        <div class="">
                            <center>
                                <span class="h-subtitle h-m-title"><strong>JENDELA KOMBINASI</strong></span>
                            </center>
                            ...
                            <div class="row">
                                <?php if ($this->agent->is_mobile()) : ?>
                                    <div class="col-sm-12 col-xs-12">
                                        <img src="<?= base_url('assets/user/images/kategori/splus-sash/combinasi/m-detail.jpg') ?>">
                                    </div>
                                <?php else : ?>
                                    <div class="col-md-12">
                                        <img src="<?= base_url('assets/user/images/kategori/splus-sash/combinasi/detail.jpg') ?>">
                                    </div>
                                <?php endif; ?>
                            </div> <br>
                            <div class="">
                                <center>
                                    <span class="h-subtitle h-m-title" style="margin-top: 60px;"><strong>PORTFOLIO</strong></span>
                                </center>
                                <hr style="margin-bottom: 25px;width: 18%; border: 0.5px solid #e24545">
                                <div class="row gallery-popup">
                                    <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                                        <img src="<?= base_url('assets/user/images/portfolio/jendela/kombinasi/p1.jpg') ?>" alt="">
                                    </div>
                                    <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12 h-m-pdk">
                                        <img src="<?= base_url('assets/user/images/portfolio/jendela/kombinasi/p2.jpg') ?>" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
