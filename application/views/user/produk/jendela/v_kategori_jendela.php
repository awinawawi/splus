            ...
            <div class="row pb-50 pt-50">
                        ...
                        <aside class="ps-widget--sidebar ">
                            ...
                            <div class="ps-widget__content ">
                                <ul class="ps-list--arrow">
                                    ...
                                    <li class="panel-title" data-toggle="collapse" data-target="#test2">
                                        <a href="<?= base_url('kategori/s-plus-upvc-jendela') ?>" style="color:#e24545;"><b>JENDELA</b></a>
                                        <ul id="test2">
                ...
                <div class="col-md-9">
                    <div class="ps-box pb-40 pt-20 pl-20 pr-20 bg-white shd" style="background: url('<?= base_url('assets/user/images/background/bgproduk/produkbg4.jpg') ?>'); background-size: cover;" class="pt-5">
                        <div class="">
                            <center>
                                <span class="h-subtitle h-m-title"><strong>OUR Windows</strong></span>
                            </center>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 pb-25">
                                    <div class="container_images">
                                        <div class="content_img">
                                            <a href="<?= base_url('kategori/s-plus-upvc-jendela/jendela_upvc') ?>">
                                                <img src="<?= base_url('assets/user/images/kategori/produk/jendela/upvc_windows/upvc-jendela.jpg') ?>" alt="" class="image" width="80%">
                                                <div>More Detail</div>
                                            </a>
                                        </div>
                                        <div class="text-center">
                                            <div class="text-overlay-ss">UPVC WINDOWS </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 pb-20">
                                    <div class="container_images">
                                        <div class="content_img">
                                            <a href="<?= base_url('kategori/s-plus-upvc-jendela/jendela_IROOM') ?>">
                                                <img src="<?= base_url('assets/user/images/kategori/produk/jendela/iroom_windows/iroom4.jpg') ?>" alt="" class="image" width="80%">
                                                <div>More Detail</div>
                                            </a>
                                        </div>
                                        <div class="text-center">
                                            <div class="text-overlay-ss">IROOM WINDOWS</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
