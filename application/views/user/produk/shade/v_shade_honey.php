<?php
$meta['title']          = 'Honeycomb - S-Plus Indonesia';
$meta['description']    = 'S-Plus Sun shade honeycomb berfungsi sebagai pelindung ruangan dari sinar matahari & pendukung keindahan interior anda, tidak hanya berfungsi sebagai pelindung ruangan dari efek negatif panas dan cahaya sinar matahari.';
$meta['keywords']       = 'jual sun shade honeycomb, jual sun shade honeycomb murah, jual sun shade honeycomb berkualitas, jual sun shade honeycomb terbaik, sun shade honeycomb murah, sun shade honeycomb minimalis, sun shade honeycomb elegan, sun shade honeycomb terbaik, sun shade honeycomb berkualitas,,roller blind, roller blind harga, roller blind s plus, sun shade s plus, roller blind honey';
                            ...
                            <ul class="ps-list--arrow">
                                ...
                                <ul id="test2" class="panel-collapse collapse">
                                    ...
                                    <li class="sm"><a href="<?= base_url('kategori/s-plus-upvc-jendela/sliding') ?>">Jendela
                                            Sliding</a></li>
                                    <li class="sm"><a href="<?= base_url('kategori/s-plus-jendela/swing') ?>">Jendela
                                            Swing</a></li>
                                ...
                                <ul id="test5">
                                    ...
                                    <li class="sm current"><a href="<?= base_url('kategori/s-plus-sun-shade/honeycomb') ?>">Honeycomb</a></li>
                                </ul>
                    ...
                    <div class="ps-box pb-60 pt-20 pl-20 pr-20 bg-white shd">
                        <div class="">
                            ...
                            <ul class="a h-body h-m-body">
                                <li>Bahan utama Honeycomb adalah Polyester 100%.</li>
                                <li>Berat : 216g/m2 ± 5%</li>
                                <li>Ketebalan : 0.82 mm ± 5%</li>
                                <li>Direkomendasikan untuk didalam ruangan atau di ruangan.</li>
                            </ul>
                        </div>
                        <br>
                        <div class="">
                            <center>
                                <span class="h-subtitle h-m-title"><strong>HONEYCOMB</strong></span>
                            </center>
                            <hr style="margin-bottom: 25px;width: 15%; border: 0.5px solid #e24545">
                            <div class="row">
                                <?php if ($this->agent->is_mobile()) : ?>
                                    <div class="col-sm-12 col-xs-12">
                                        <img src="<?= base_url('assets/user/images/kategori/produk/sun_shade/honeycomb-m.jpg') ?>">
                                    </div>
                                <?php else : ?>
                                    <div class="col-md-12">
                                        <img src="<?= base_url('assets/user/images/kategori/produk/sun_shade/honeycomb.jpg') ?>">
                        ...
                        <br>
                        <a href="<?= base_url('order/sunshade-honeycomb') ?>" class="btn btn-primary pull-right">PESAN SEKARANG</a>
                    </div>
                </div>
            </div>
        </div>
