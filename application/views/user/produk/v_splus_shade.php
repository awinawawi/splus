                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 pb-25">
                                    <div class="container_images">
                                        ...
                                        <a href="<?=base_url('kategori/s-plus-sun-shade/combi')?>">
                                            <img src="<?=base_url('assets/user/images/kategori/splus-shade/combi/1.jpg')?>"
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 pb-20">
                                    <div class="container_images">
                                        ...
                                        <a href="<?=base_url('kategori/s-plus-sun-shade/roll-screen')?>">
                                            <img src="<?=base_url('assets/user/images/kategori/splus-shade/roll-screen/1.jpg')?>"
                                                alt="" class="image" width="80%">
                                            <div>More Detail</div>      
                                        </a>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 pb-50">
                                    <div class="container_images">
                                        ...
                                        <a href="<?=base_url('kategori/s-plus-sun-shade/sun-screen')?>">
                                            <img src="<?=base_url('assets/user/images/kategori/splus-shade/sun-screen/1.jpg')?>"
                                                alt="" class="image" width="80%">
                                            <div>More Detail</div>      
                                        </a>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 pb-50">
                                    <div class="container_images">
                                        ...
                                        <a href="<?=base_url('kategori/s-plus-sun-shade/blackout')?>">
                                            <img src="<?=base_url('assets/user/images/kategori/splus-shade/blackout/1.jpg')?>"
                                                alt="" class="image" width="80%">
                                            <div>More Detail</div>      
                                        </a>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 pb-20">
                                    <div class="container_images">
                                        ...
                                        <a href="<?=base_url('kategori/s-plus-sun-shade/vertical')?>">
                                            <img src="<?=base_url('assets/user/images/kategori/splus-shade/vert-blind/1.jpg')?>"
                                                alt="" class="image" width="80%">
                                            <div>More Detail</div>      
                                        </a>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 pb-25">
                                    <div class="container_images">
                                        ...
                                        <a href="<?=base_url('kategori/s-plus-sun-shade/wood')?>">
                                            <img src="<?=base_url('assets/user/images/kategori/splus-shade/wood-blind/1.jpg')?>"
                                                alt="" class="image" width="80%">
                                            <div>More Detail</div>      
                                        </a>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 pb-25">
                                    <div class="container_images">
                                        ...
                                        <a href="<?=base_url('kategori/s-plus-sun-shade/honeycomb')?>">
                                            <img src="<?=base_url('assets/user/images/kategori/splus-shade/honeycomb/1.jpg')?>"
                                                alt="" class="image" width="80%">
                                            <div>More Detail</div>      
                                        </a>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 pb-50">
                                    <div class="container_images">
                                        ...
                                        <a href="<?=base_url('kategori/s-plus-sun-shade/alumunium')?>">
                                            <img src="<?=base_url('assets/user/images/kategori/splus-shade/alumunium/1.jpg')?>"
                                                alt="" class="image" width="80%">
                                             <div>More Detail</div>     
                                        </a>
                                        </div>
