            ...
            <div class="row pb-50 pt-50">
                ...
                <div class="col-lg-12">
                    <div class="ps-box pb-40 pt-20 pl-20 pr-20 bg-white shd">
                        <div>
                            <h4><a href="<?= base_url('v_kategori') ?>"><b>Produk </b></a><span class="fa fa-chevron-right"></span><a href="<?= base_url('kategori/s-plus-pintu') ?>"><b> Pintu </b></a><span class="fa fa-chevron-right"></span><a href="<?= base_url('kategori/s-plus-pintu/iroom_door') ?>"><b> Pintu Iroom </b></a><span class="fa fa-chevron-right"><b> Iroom Door </b></h4>
                            <br>
                        </div>
                        <div class="">
                        ...
                        <div class="row pb-20" style="padding-bottom:10px;">
                            ...
                            <?php if ($this->agent->is_mobile()) : ?>
                                <div class="col-sm-12 col-xs-12 gallery-popup" style="padding-bottom:5px;">
                                    ...
                                    <div><img style="padding-top:15px;" src="<?= base_url('assets/user/images/kategori/produk/pintu/iroom/pintu-m.jpg') ?>"></div>
                                </div>
                            <?php else : ?>
                                <div class="col-md-12 pb-40 gallery-popup" style="padding-bottom:5px;">
                                    ...
                                    <div><img style="padding-top:15px;" class="" src="<?= base_url('assets/user/images/kategori/produk/pintu/iroom/pintu.jpg') ?>"></div>
                                </div>
                            <?php endif; ?>
