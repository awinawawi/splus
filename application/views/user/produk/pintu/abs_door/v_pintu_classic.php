<?php
$meta['title']          = 'Pintu Classic - S-Plus Indonesia';
$meta['description']    = 'Pintu Classic merupakan salah satu pintu yang dimiliki S-Plus. Pintu Classic ini memiliki desain yang elegan tapi masih memiliki unsur classic. Pintu Classic memiliki bobot yang lebih ringan tetapi masih memiliki daya tahan yang kuat dan dengan harga ekonomis';
            ...
            <div class="row pb-50 pt-50">
                ...
                <div class="col-lg-12">
                    <div class="ps-box pb-60 pt-20 pl-20 pr-20 bg-white shd">
                        <div>
                            <h4><a href="<?= base_url('v_kategori') ?>"><b>Produk </b></a><span class="fa fa-chevron-right"></span><a href="<?= base_url('kategori/s-plus-pintu') ?>"><b> Pintu </b></a><span class="fa fa-chevron-right"></span><a href="<?= base_url('kategori/s-plus-pintu/abs') ?>"><b> Pintu ABS </b></a><span class="fa fa-chevron-right"><b> Classic Door </b></h4>
                            <br>
                        </div>
                        <div class="">
                        ...
                        <div class="">
                            <center>
                                <span class="h-subtitle h-m-title" style="color:#F08519;"><strong>CLASSIC</strong></span>
                            </center>
                            <hr style="margin-bottom: 25px;width: 100%; border: 0.5px solid #000000">
                            <span class="h-body h-m-body">
                                Pintu ekonomis dengan desain Classic dapat membuat interior rumah anda terlihat elegan pada setiap ruangan karena didesain dengan karakteristik yang khas
                            </span>
                            <div class="row">
                                <?php if ($this->agent->is_mobile()) : ?>
                                    <div class="col-sm-12 col-xs-12">
                                        <img src="<?= base_url('assets/user/images/kategori/splus-door/web-abs/clasic-m.jpg') ?>" style="padding-top:20px;">
                                    </div>
                                <?php else : ?>
                                    <div class="col-md-12">
                                        <img src="<?= base_url('assets/user/images/kategori/splus-door/web-abs/clasic.jpg') ?>" style="padding-top:20px;">
                                    </div>
                                <?php endif; ?>
                            </div>

                            <div class="pt-40 text-center pb-10">
                                <span class="h-subtitle h-m-title" style="color:#F08519;"><strong>Pilihan Warna Pintu Classic</strong></span>
                                <hr style="margin-bottom: 25px;width: 40%; border: 0.5px solid #000000">
                                <img width="<?php echo ($this->agent->is_mobile() ? "50%" : "25%") ?>" src="<?= base_url('assets/user/images/kategori/splus-door/classic/warna.png') ?>" alt="">
                            </div>

                            <div class="pt-40 text-center pb-10">
                                <span class="h-subtitle h-m-title" style="color:#F08519;"><strong>Pilihan Standar Ukuran (Lebar x Tinggi) (mm)</strong></span>
