                                ...
                                <div id="jssor_1"
                                    ...
                                    <div data-u="slides"
                                        ...
                                        <div style="background-color:#000000;">
                                            <img data-u="image"
                                                src="<?=base_url('assets/user/images/kategori/splus-door/felice/felice.jpg')?>" />
                                        </div>

                                        <div style="background-color:#000000;">
                                            <img data-u="image"
                                                src="<?=base_url('assets/user/images/kategori/splus-door/sash-door/detail.jpg')?>" />
                                        </div>
                                    </div>
                                    <!-- Bullet Navigator -->
                                ...
                                <div class="ps-product--detail pt-30">
                                    <div class="ps-container">
                                        <div class="row">
                                            <div class="col-md-9">
                                                <div><img class=""
                                                    src="<?=base_url('assets/user/images/kategori/splus-door/felice/detail.png')?>">         
                                                </div>
                                            </div>
                                        </div>
                                    </div>
