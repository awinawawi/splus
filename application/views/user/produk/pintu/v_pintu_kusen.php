<?php
$meta['title']          = 'Kusen Pintu - S-Plus Indonesia';
$meta['description']    = 'S-Plus menyediakan kusen untuk produk pintu abs dan upvc, dengan berbagai pilihan ukuran yang sesuai dengan kebutuhan.';
$meta['keywords']       = 'jual kusen pintu abs, jual kusen pintu abs murah, jual kusen pintu abs berkualitas, jual kusen pintu abs terbaik, kusen pintu abs murah, kusen pintu abs minimalis, kusen pintu abs elegan, kusen pintu abs terbaik, kusen pintu abs berkualitas, kusen s plus, kusen murah';
            ...
            <div class="row pb-50 pt-50">
                ...
                <div class="col-lg-12">
                    <div class="ps-box pb-40 pt-20 pl-20 pr-20 bg-white shd">
                        ...
                        <div class="">
                            <center>
                                <span class="h-subtitle h-m-title"><strong>KUSEN</strong></span>
                            </center>
                            <hr style="margin-bottom: 25px;width: 10%; border: 0.5px solid #e24545">
                            <div class="row">
                                <?php if ($this->agent->is_mobile()) : ?>
                                    <div class="col-sm-12 col-xs-12">
                                        <img src="<?= base_url('assets/user/images/kategori/splus-kusen/detail-mobile-kusen.jpg') ?>">
                                    </div>
                                <?php else : ?>
                                    <div class="col-md-12">
                                        <img src="<?= base_url('assets/user/images/kategori/splus-kusen/detail-kusen.jpg') ?>">
                            ...
                            <div class="pt-40 text-center">
                                ...
                                <hr style="margin-bottom: 15px;width: 25%; border: 0.5px solid #e24545">
                                <img width="<?php echo ($this->agent->is_mobile() ? "100%" : "50%") ?>" src="<?= base_url('assets/user/images/kategori/splus-kusen/ukuran-kusen.png') ?>" alt=""> <br>
                                <!-- <span class="text-danger">* Tersedia ukuran custom</span> -->
                            </div>
                            <div class="row pt-40">
                                <center>
