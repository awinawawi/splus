                ...
                <form class="form-horizontal" action="<?php echo base_url() . 'admin/kategori/simpan_kategori' ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="nama_kategori" class="form-control" id="inputUserName" placeholder="Nama Kategori" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <textarea id="ckeditor" name="deskripsi_kategori" class="form-control ckedit" placeholder="Deskripsi Kategori" required></textarea>
                            </div>
                        </div>
