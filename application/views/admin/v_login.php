...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg"> <img src="<?php echo base_url().'assets/user/images/logi-1.png'?>"></p><hr/>
    ...
    <!-- /.social-auth-links -->
    <hr/>
    <p><center>Copyright <?php echo '2020'?> by S Plus Indonesia <br/> All Right Reserved</center></p>
  </div>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
