...
<body>
    ...
    <div class="page-arul" style="background: url('<?= base_url('assets/images/shop.jpg') ?>'); background-size: cover;" class="pt-20; ">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            <p></p>
            <h2>Bagaimana cara berbelanja di Splus Indonesia?</h2>
            <ol>
                <li style="padding:10px;font-size:20px;list-style:auto;">Pilih produk yang ingin dipesan.</li>
                <li style="padding:10px;font-size:20px;list-style:auto;">Tambahkan produk ke keranjang belanja.</li>
                <li style="padding:10px;font-size:20px;list-style:auto;">Pilih jasa logistik yang mau digunakan.</li>
                <li style="padding:10px;font-size:20px;list-style:auto;">Lakukan pembayaran.</li>
            </ol>
            <h2>Kapan saya menerima pesanan saya?</h2>
            <div>
