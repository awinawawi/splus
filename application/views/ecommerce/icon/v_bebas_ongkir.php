...
<body>
    ...
    <div class="page-arul" style="background: url('<?= base_url('assets/images/ongkir.jpg') ?>'); background-size: cover;" class="pt-20; ">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            <p></p>
            <h2>Pengiriman Splus Indonesia</h2>
            <p style="font-size:20px;">Apa saja kelebihan pengiriman Splus Indonesia?</p>
            <ol>
                <li style="padding:10px;font-size:20px;list-style:auto;">Nikmati gratis ongkos kirim. Selalu ada promo gratis ongkos kirim untuk jarak dan minimal belanja tertentu. Ini bisa menghemat uang Anda.</li>
                <li style="padding:10px;font-size:20px;list-style:auto;">Barang akan aman sampai ke tempat tujuan, ke lokasi Anda. Terjamin barang tidak akan pecah atau rusak saat dikirim.</li>
                <li style="padding:10px;font-size:20px;list-style:auto;">Barang bisa sampai lebih cepat ke lokasi Anda.</li>
            </ol>
        </div>
    </div>
