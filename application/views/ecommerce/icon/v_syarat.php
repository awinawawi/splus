...
<body>
    ...
    <div class="page-arul" style="background: url('<?= base_url('assets/images/syarat_k.jpg') ?>'); background-size: cover;" class="pt-20; ">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <center><span class="h-title h-m-title">SYARAT & KETENTUAN</span></center>
                <hr style="width: 25%; margin-top: 5px; margin-bottom: 15px; border: 1px solid #e24545;">
                <span style="text-align: justify;" class="h-body h-m-body">&emsp; Halaman ini menampilkan Syarat dan Ketentuan berdasarkan produk yang di tawarkan oleh S-Plus Indonesia kepada Anda. Bacalah term and Condition kami sebagai pedoman untuk berbelanja di splusindonesia.com. Dengan memesan dan membeli produk S-Plus Indonesia pada website ini berarti anda menyetujui syarat dan ketentuan yang berlaku.</span>
                <br><br><br>
                <span class="h-subtitle h-m-title">CONDITIONS OF SITE USE</span>
                <div class="condition pl-40 pb-40">
                    <br><span style="text-align: justify;" class="h-body h-m-body">&emsp; Saat Anda mengunjungi dan menggunakan situs splusindonesia.com, termasuk semua fitur dan layanannya, Anda diwajibkan untuk mematuhi ketentuan berikut:</span>
                    <br><br>
                    <ul class="r h-body h-m-body" style="text-align: justify;">
                        <li>Akses ke situs ini hanya diperbolehkan untuk tujuan belanja dan memperoleh informasi yang berkaitan dengan layanan yang disediakan di situs ini.</li>
                        <li>Anda tidak diperbolehkan untuk mereproduksi, mendistribusikan, menampilkan, menjual, menyewakan, mengirimkan, membuat karya turunan, menerjemahkan, memodifikasi, merekayasa balik, membongkar, menguraikan, atau mengeksploitasi website splusindonesia.com.</li>
                    </ul>
                </div>

                <span class="h-subtitle h-m-title">TRANSACTIONS</span>
                <div class="transaction pl-40 pb-40">
                    <ul class="r h-body h-m-body pt-20" style="text-align: justify;">
                        <li>Harga yang ditampilkan pada situs splusindonesia sudah termasuk ongkos kirim dan biaya logistik, dengan menggunakan Ekspedisi Internal S-Plus Indonesia.</li>
                        <li>Untuk membeli secara online melalui shopping cart, pesanan, dan pengiriman akan diproses setelah pembayaran diterima oleh rekening bank atas nama PT. Smart TechTex.
                        </li>
                        <li>Apabila anda menerima produk dengan kondisi rusak, silahkan hubungi pusat layanan costumer di (0231)-8511781-85 atau email ke sales@splusindonesia.com untuk bantuan lebih lanjut.</li>
                        <li>S-Plus Indonesia akan bertanggung jawab penuh atas kualitas produk yang diberikan.
                        </li>
                        <li>Anda akan menerima notifikasi email yang berisi Invoice Pengiriman paling lambat 2×24 jam setelah order di website splusindonesia.com</li>
                    </ul>
                </div>

                <span class="h-subtitle h-m-title">PRICE</span>
                <div class="price pl-40 pb-40">
                    <br><span style="text-align: justify;" class="h-body h-m-body">&emsp; Jika dalam keadaan tertentu, ada kesalahan harga atau informasi yang salah pada produk tertentu akibat dari salah ketik atau kesalahan tarif dan informasi dari Anda, S-Plus Indonesia berhak untuk menolak atau membatalkan pesanan Anda. Apabila Anda telah melakukan pembayaran, maka S-Plus Indonesia akan mengembalikan dana sesuai dengan jumlah pembayaran Anda.</span>
                </div>

                <span class="h-subtitle h-m-title">REGISTERED USERS</span>
                <div class="registered pl-40">
                    <ul class="r h-body h-m-body pt-20" style="text-align: justify;">
                        <li>Saat melakukan regrister anggota di S-Plus Indoesia tidak dikenakan biaya.</li>
                        <li>Anggota S-Plus Indoesia bertanggung jawab untuk menjaga kerahasiaan ID dan password akun. Semua anggota yang terdaftar bertanggung jawab untuk semua kegiatan yang dilakukan.</li>
                        <li>Pastikan bahwa Anda untuk keluar dari akun setiap setelah selesai melakukan aktivitas di website Splusindoesia.com untuk meminimalkan kemungkinan penyalah gunaan account Anda.</li>
                        <li>S-Plus Indoesia berhak sepenuhnya untuk membatasi, blok, atau menghentikan layanan setiap akun anggota yang memperlambat atau menyalah gunakan akses user, dan mengambil langkah-langkah hukum jika S-Plus Indonesia anggap bahwa orang tersebut telah melanggar hukum yang berlaku, melanggar hak kekayaan intelektual, atau melakukan pelanggaran yang terkandung dalam Perjanjian ini.</li>
                    </ul>
                </div>
