...
<div class="site__header d-lg-block ">
 
    <h3 class="title text-left" style="color:#007bff;">USER LOGIN</h3>
</div>
    ...
    <div class="card flex-grow-1 mb-0">
        ...
        <div class="card-body">
            ...
            <form action="<?= base_url('register'); ?>" method="post">
                ...
                <hr>
                <button type="submit" name="submit" class="btn btn-primary mt-4" style="padding-top: 2px;">Daftar</button>
                <a class="btn btn-default mt-4 float-right" href='<?= base_url('login') ?>' style="padding-top: 2px;">Sudah Punya Akun?</a>
            </form>
        </div>
...
<div class="col-md-6 d-flex flex-column mt-md-1 mx-auto">
                <a ><img  class="d-block w-100" src="<?= base_url() ?>assets/images/logo/SSA.jpg" alt="" style="margin-top: 100px;"></a>
            </div>