...
<head>
	...
	<title>Splus Ecommerce | Exterior Material</title>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="inner-content">
						...
						<span>Featured Exterior Material products</span>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="section" id="products">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-9">
					<h2 align="center">Product Exterior</h2>
					<br />
					<div align="center">
					</div>
					<br />
			...
			<script>
				$(document).ready(function() {
					...
					function filter_data(page) {
						...
						$.ajax({
							url: "<?php echo base_url(); ?>product_filter_exterior/fetch_data/" + page,
							method: "POST",
							dataType: "JSON",
							data: {
								action: action,
