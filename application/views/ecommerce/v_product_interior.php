            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="inner-content">
                        <h2 style="color:black;">Our Products Interior</h2>
                        <span style="color:black;">Featured Interior products</span>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="section-heading" style="text-align:left;">
                                <aside class="ps-widget--sidebar ">
                                    ...
                                    <div class="widget-box">
                                        ...
                                        <form class="example" action="<?= base_url('Order/cari_interior') ?>" method="POST">
                                    ...
                                    <div class="ps-widget">
                                        <div class="panel-group category-products" id="accordian">
                                            <?php $data = $this->db->query("SELECT * from tbl_kategoriproduk where id_kategori_produk='3' order by id_kategori_produk Asc"); ?>
                                            <?php $data1 = $this->db->query("SELECT * from tbl_subkategoriproduk where id_kategori_produk='3' order by id_subkategori_produk Asc"); ?>
                                                    ...
                                                    <div class="panel-heading">
                                                        <h4 class="panel-title">
                                                            <a data-toggle="collapse" data-parent="#accordian" href="#<?php echo $maincat->nama_kategori; ?>">
                                                                ...
                                                                <?php echo "JENIS-JENIS INTERIOR MATERIAL" ?>
                                                            </a>
                                                        </h4>
                                                    </div>
                                                    <br></br>
                                                            ...
                                                            <ul>
                                                                <?php foreach ($data1->result() as $subcat) { ?>
                                                                    <?php if ($subcat->id_kategori_produk == $maincat->id_kategori_produk) { ?>
                                                                        ...
                                                                        <li><a href="<?= base_url('order/product_interior/' . $subcat->id_subkategori_produk) ?>">
                                    ...
                                    <div class="ps-widget__content">
                                        <div class="widget-products widget">
                                            ...
                                            <div style="height: 200px; overflow-y: auto; overflow-x: hidden;">
                                                <?php $tipex = $this->db->query('SELECT * FROM tbl_produk_varian WHERE produk_id="3" group by varian_type
                                                                ');
                                                foreach ($tipex->result_array() as $kat) {
                                                ?>
                                                    <div class="form-check" style="padding-left: 10px;">
                                                        <label>
                                                            <input class="common_selector storage" type="checkbox" onclick="location.href='<?= base_url('order/tipe_interior/') . $kat['id_tipe_produk']  ?>'">
                                                            <?= $kat['varian_type'] ?></BR>
                                                        </label>
                                                    </div>
                                ...
                                <div class="dropdown" style="margin-left:0px;">
                                    ...
                                    <div class="dropdown-content">
                                        <a href="<?= base_url('order/arrival_i/') . $kat['id_rekomendasi']  ?>" class="w3-bar-item w3-button">NEW ARRIVAL</a>
                                        <a href="<?= base_url('order/spesial_i/') . $kat['id_rekomendasi']  ?>" class="w3-bar-item w3-button">SPECIAL OFFERS</a>
                                        <a href="<?= base_url('order/manyviews_i/') . $kat['id_rekomendasi']  ?>" class="w3-bar-item w3-button">LATEST PRODUCTS</a>
                        ...
                        <section class="section" id="products">
                            <div class="">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="section-heading">
                                            <h2>Products Interior Material</h2>
                                ...
                                <div class="container">
                                    ...
                                    <!-- <div class="container">
                                        <div class="row">
                                            <a class="col-md" style="background-color:yellow;" href="<?= base_url('order/arrival_i/') . $kat['id_rekomendasi']  ?>">
                                                NEW ARRIVAL
                                            </a>
                                            <a class="col-md" style="background-color:pink;" href="<?= base_url('order/spesial_i/') . $kat['id_rekomendasi']    ?>">
                                                SPECIAL OFFERS
                                            </a>
                                            <a class="col-md" style="background-color:brown;" href="<?= base_url('order/manyviews_i/') . $kat['id_rekomendasi'] ?>">
                                                LATEST PRODUCTS
                                            </a>
                                        </div>
                                    </div>
