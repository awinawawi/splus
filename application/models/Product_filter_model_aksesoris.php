...
class Product_filter_model_aksesoris extends CI_Model
{
    ...
    // WHERE a.product_status = '1' AND a.produk_id='5'";
    ...
    function fetch_filter_type($type)
    {
        ...
        $this->db->where('tbl_varian_coba.produk_kategori', '6');
        return $this->db->get();
    }
