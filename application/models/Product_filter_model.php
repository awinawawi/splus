...
class Product_filter_model extends CI_Model
{
    ...
    //         $query = "
    // SELECT * FROM tbl_produk_varian a INNER JOIN tbl_produk b  ON a.produk_id=b.produk_id
    // WHERE a.product_status = '1' AND a.produk_id='2'
    // ";
    ...
    function fetch_filter_type($type)
    {
        ...
        $this->db->where('tbl_varian_coba.produk_kategori', '2');
        return $this->db->get();
    }
