...
class M_kategori extends CI_Model
{
	...
	function update_kategori($kategori_id, $kategori_nama, $kategori_deskripsi, $gambar)
	{
		$hsl = $this->db->query("update tbl_kategori set kategori_nama='$kategori_nama',kategori_deskripsi = '$kategori_deskripsi',kategori_cover='$gambar' where kategori_id='$kategori_id'");
		return $hsl;
	}

	function update_kategori_tanpa_img($kategori_id, $kategori_nama, $kategori_deskripsi)
	{
		$hsl = $this->db->query("update tbl_kategori set kategori_nama='$kategori_nama',kategori_deskripsi = '$kategori_deskripsi' where kategori_id='$kategori_id'");
		return $hsl;
	}
