...
DROP TABLE IF EXISTS `tbl_produk_varian2`;

CREATE TABLE `tbl_produk_varian2` (
  `varian_id` int(11) NOT NULL AUTO_INCREMENT,
  `produk_id` int(11) NOT NULL,
  `id_subkategori_produk` int(11) NOT NULL,
...
/*Data for the table `tbl_produk_varian2` */

insert  into `tbl_produk_varian2`(`varian_id`,`produk_id`,`id_subkategori_produk`,`id_tipe_produk`,`id_rekomendasi`,`varian_type`,`varian_nama`,`varian_gambar_depan`,`varian_gambar_utama`,`varian_gambar_warna`,`varian_harga`,`varian_harga_meter`,`varian_jumlah`,`varian_deskripsi`,`varian_ukuran`,`varian_warna`,`tokopedia`,`bukalapak`) values 
